...
export let gallery1PortraitImage: string | null = d.gallery1.portraitImage;
...
export let secretObservation: { title: string; text: string } = d.gallery2.secretObservation;
...
function refreshBindings() {
  ...
  gallery1PortraitImage = d.gallery1.portraitImage;
  ...
  secretObservation = d.gallery2.secretObservation;
