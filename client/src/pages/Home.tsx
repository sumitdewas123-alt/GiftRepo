...
import { birdLogoImage, openingPageImage } from "@/lib/museumData";
    ...
    <div className="min-h-screen" style={{ animation: "fadeIn 1.2s ease both" }}>
      ...
      <main id="main" key={dataVersion}>
        ...
        <section className="paper-texture relative flex min-h-[60vh] flex-col items-center justify-center bg-background px-6 py-24 text-center" aria-label="Museum welcome">
          <img src={openingPageImage || birdLogoImage || "/manus-storage/logo-bird_bdea2d3a.png"} alt="" className="h-16 w-16" style={{ animation: "floatSlow 5s ease-in-out infinite" }} />
